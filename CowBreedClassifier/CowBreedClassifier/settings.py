...
SECRET_KEY = 'django-insecure-2-kpswtg$r8x1px^r-8d08%sfl*9%l9*erqljs97t66i=0a1%r'
...
ROOT_URLCONF = 'CowBreedClassifier.urls'
...
WSGI_APPLICATION = 'CowBreedClassifier.wsgi.application'
